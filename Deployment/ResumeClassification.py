...
# MAIN CODE
import pickle as pk
model = pk.load(open(r'/Users/rmanoj/Resume Classification Project/modelDT.pkl', 'rb'))
Vectorizer = pk.load(open(r'/Users/rmanoj/Resume Classification Project/vector.pkl', 'rb'))
